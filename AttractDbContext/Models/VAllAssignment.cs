...
public partial class VAllAssignment
{
    ...
    public int? JobOrderClientId { get; set; }

    public string? JobOrderClientName { get; set; }
    ...
    public string? JobOrderAddress1 { get; set; }

    public string? JobOrderAddress2 { get; set; }

    public string? JobOrderCity { get; set; }

    public string? JobOrderStateName { get; set; }

    public string? JobOrderZipCode { get; set; }

    public string? JobOrderContactEmail { get; set; }
    ...
    public string? JobOrderJobOrderDescription { get; set; }
    ...
    public string? AssignmentAssignmentDescription { get; set; }
    ...
    public int? Assignmentpayrateid { get; set; }
    ...
    public string? AssignmentTerminationReasonValue { get; set; }

    public DateTime? AssignmentTerminationDt { get; set; }

    public decimal SiteAcarate { get; set; }

    public decimal ClientAcarate { get; set; }

    public int? AssignmentBranchId { get; set; }

    public int? DnrId { get; set; }

    public int? ClientDnr { get; set; }

    public string? Dnrnote { get; set; }

    public int? JobOrderDnr { get; set; }

    public int? JobSiteDnr { get; set; }
}
